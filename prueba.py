...
cur.executemany(" INSERT INTO tbl1 VALUES (?,?,?,?,?,?,?)",
...
cur.executemany(" INSERT INTO tbl0 VALUES (?,?,?,?,?)",
...
#print(cur.execute("SELECT * FROM tbl0 WHERE c02 = 100 OR c02 = 600;").fetchall())

#print(cur.execute("SELECT * FROM tbl1 WHERE K0 = 'A'  ORDER BY c14;").fetchall())

#print(cur.execute("SELECT * FROM tbl1 WHERE K0 != 'A' AND K0 != 'B' AND c13 != 200 AND c13 != 900 ORDER BY c14;").fetchall())
conn.executescript(
    """
CREATE TABLE tbl2 (
    K1  INT,
...
cur.executemany(" INSERT INTO tbl2 VALUES (?,?,?,?,?,?)",
...
##print(cur.execute("SELECT c23 FROM tbl2;").fetchall()) 8888

#print(cur.execute("SELECT * FROM tbl2 WHERE c21= (SELECT MIN(c21) FROM tbl2) ;").fetchall())



#print(cur.execute("SELECT * FROM tbl0 WHERE c02>=300;").fetchall())
